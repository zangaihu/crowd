...
import com.sh.exception.LoginAcctAlreadyInUseForUpdateException;
...
/**
 * Created By Sunhu At 2020/6/3 13:42
 * 异常处理，controllerAdvice 注解
 *
 * @author Sun
 */
...
public class GlobalExceptionResolver {
    ...
    private ModelAndView commonResolve(
        ...
        if(judgeResult) {
            ...
            // 3.创建ResultEntity对象
            ResultEntity<Object> resultEntity = ResultEntity.failed("禁止访问");
